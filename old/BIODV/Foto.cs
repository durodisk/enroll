...
namespace BIODV
{
	public class Foto : Form
	{
		...
		static Foto()
		{
			Foto.cascadeclassifier = new CascadeClassifier("haarcascade_frontalface_alt_tree.xml");
		}
		...
		private void button1_Click_1(object sender, EventArgs e)
		{
			...
			else
			{
				...
				Foto.Captura = this.bitmap2;
				this.pictureBox2.Image = Foto.Captura;
			}
		}
		...
		private void Device_NewFrame(object sender, NewFrameEventArgs eventArgs)
		{
			try
			{
				...
				CascadeClassifier cascadeClassifier = Foto.cascadeclassifier;
		...
		{
			ComponentResourceManager resources = new ComponentResourceManager(typeof(Foto));
