	...
	public class Serializer
	{
		...
		public CapturedPerson DeserializeEpd(string pRuta)
		{
			...
			try
			{
				try
				{
					PersonaCapturada = (CapturedPerson)(new BinaryFormatter()).Deserialize(fs);
				}
		...
		{
			DataTable dt = (new IswArchivosClient()).ObtenerUsuarios(ref vMensaje);
		...
		public string RandomString(int length)
		{
			string str = new string((
				...
				select s[Serializer.random.Next(s.Length)]).ToArray<char>());
			return str;
		}
