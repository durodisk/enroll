...
namespace BIODV
{
	public class fUsuarioReseteo : Form
	{
		...
		{
			if (string.IsNullOrWhiteSpace(fLogin.usuario))
			{
			...
			{
				this.txtUsuario.Text = fLogin.usuario;
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager resources = new ComponentResourceManager(typeof(fUsuarioReseteo));
		...
		{
			return Validador.ValidarCampos(new DatosPasswordReset()
			{
