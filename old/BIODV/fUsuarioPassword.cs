...
namespace BIODV
{
	public class fUsuarioPassword : Form
	{
		...
		private void button1_Click(object sender, EventArgs e)
		{
			if (this.ValidaModeloDatosUsuario())
			{
				...
				List<Usuario> vColUsuarios = (
					...
					where cust.txtUsuario == fLogin.usuario
				...
				else
				{
					...
					else
					{
						...
						_usuarios.ListaUsuario.First<Usuario>((Usuario x) => x.txtUsuario == fLogin.usuario).Pass = vPassword;
						_usuarios.ListaUsuario.First<Usuario>((Usuario x) => x.txtUsuario == fLogin.usuario).FechaModificacion = DateTime.Now;
						_usuarios.ListaUsuario.First<Usuario>((Usuario x) => x.txtUsuario == fLogin.usuario).UsuarioModificacion = fLogin.usuario;
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager resources = new ComponentResourceManager(typeof(fUsuarioPassword));
		...
		{
			return Validador.ValidarCampos(new DatosPassword()
			{
