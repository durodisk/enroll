...
namespace BIODV.swCentralCore
{
	...
	public class CrearUsuarioRequest
	{
		...
		public CrearUsuarioRequest(string pMensajebd, string pNumeroDocumento, string pComplemento, string pPrimerNombre, string pSegundoNombre, string pPrimerApellido, string pSegundoApellido, string pUsuario, string pPassword, string pUnidad, DateTime pCreated, string pCreatedBy)
		{
