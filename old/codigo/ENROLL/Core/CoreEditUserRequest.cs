...
namespace ENROLL.Core
{
	...
	public class CoreEditUserRequest
	{
		...
		public CoreEditUserRequest()
		{
		}

		public CoreEditUserRequest(string pMensajebd, int pIdUsuario, string pNumeroDocumento, string pComplemento, string pPrimerNombre, string pSegundoNombre, string pPrimerApellido, string pSegundoApellido, string pUsuario, string pPassword, string pUnidad, DateTime pCreated, string pCreatedBy)
		{
