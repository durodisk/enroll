...
namespace ENROLL
{
	public class vNewuser : Form
	{
		...
		{
			Usuarios _usuarios = (new HelperSerializer()).Deserialize<Usuarios>(File.ReadAllText("user/usuarios.xml")) ?? new Usuarios();
		...
		{
			List<Coder> vCoder = HelperLoadControl.ObtenerLista("UNIDADESPOLICIA");
			HelperLoadControl.Combo(this.cmbUnidadPol, vCoder, true);
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager resources = new ComponentResourceManager(typeof(vNewuser));
		...
		{
			return HelperValidatorField.ValidarCampos(new ENROLL.Model.DatosUsuario()
			{
