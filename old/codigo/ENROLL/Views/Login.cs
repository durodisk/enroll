    ...
    public class vLogin : Form
    {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Usuarios _usuarios = (new HelperSerializer()).Deserialize<Usuarios>(File.ReadAllText("user/usuarios.xml"));
                    ...
                    else
                    {
                        ...
                        vLogin.usuario = this.txtUsuario.Text.Trim();
                        vLogin.unidad = vColUsuario[0].Unidad;
        ...
        {
            if ((new vResetUser()).ShowDialog(this) != System.Windows.Forms.DialogResult.OK)
            {
            }
        }
        ...
        {
            return HelperValidatorField.ValidarCampos(new DatosLogin()
            {
