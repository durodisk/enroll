...
namespace ENROLL
{
    public class vContainer : Form
    {
        ...
        static vContainer()
        {
            vContainer.@var = "Sistema Integrado de Investigacion Criminal Enrolamiento";
        }
        ...
        private void fMaestro_Load(object sender, EventArgs e)
        {
            this.btnnormal.Visible = true;
            this.btnmaximizar.Visible = false;
            this.lbltituloform.Text = vContainer.@var;
            ...
            if ((new vLogin()).ShowDialog(this) != System.Windows.Forms.DialogResult.OK)
            {
                base.Close();
            }
            else
        ...
        {
            ComponentResourceManager resources = new ComponentResourceManager(typeof(vContainer));
            ...
            base.ClientSize = new System.Drawing.Size(1249, 750);
